...
export default function LoginForm() {
    async function signInWithEmail(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            sessionStorage.setItem("authdata", access_token);
            console.log("Inicio de sesión exitoso:", response.data);

            window.location.href = "/";
        } catch (error) {
            // @ts-ignore
            if (error.response) {// @ts-ignore
                console.error("Error en la respuesta:", error.response.data);// @ts-ignore
                alert(`Error: ${error.response.data.msg || error.response.data.error_description}`);// @ts-ignore
            } else if (error.request) {// @ts-ignore
                console.error("Error en la solicitud:", error.request);
                alert("Error: No se pudo contactar al servidor. Verifica tu conexión.");
            } else {// @ts-ignore
                console.error("Error desconocido:", error.message);// @ts-ignore
                    ...
                    <form action="#" onSubmit={signInWithEmail}>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                <input
                                    type="password"
                                    placeholder="+6 Caracteres y +1 Mayúscula"
                                    id="password"
                                    name="password"
                                    className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                />
